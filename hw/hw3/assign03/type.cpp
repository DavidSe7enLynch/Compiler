...
//    std::printf("in add_member, m_member = %s, new member = (name: %s, type: %s)\n", as_str().c_str(), member.get_name().c_str(), member.get_type()->as_str().c_str());
    m_members.push_back(member);
//    std::printf("in add_member, after push, m_member = %s\n", as_str().c_str());
}
